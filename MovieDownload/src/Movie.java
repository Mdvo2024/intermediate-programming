class Movie {
    ...
    String getMovieNameForURL() {
        ...
        movieNameForUrl = movieName.replaceAll(" ", "%20");
    ...
    */
    String getMovieFilename() {
        movieScreenshotFilename = movieName;
        movieScreenshotFilename = movieName + ".png";
        movieScreenshotFilename = movieScreenshotFilename.replaceAll(" ", "_");
        return movieName;
    } 
}
